...
O **projeto_api** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end.
...
projetos_api/
├── Desafios/          
├── Guia para APIs com JS Vanilla.pdf       
├── ex01_viaCep.html       
├── ex02_ibge.html      
├── ex03_cracha_digital.html      
└── README.md        
